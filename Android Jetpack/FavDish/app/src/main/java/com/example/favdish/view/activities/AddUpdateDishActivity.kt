...
class AddUpdateDishActivity : AppCompatActivity(), View.OnClickListener {   //use to call onclick function
    ...
    override fun onClick(v: View?) {
        if(v != null){
            when(v.id){
                ...
                R.id.btn_add_dish ->{
                    val title = mBinding.etTitle.text.toString().trim{it <= ' '}    //trim empty space
        ...
        if (resultCode == Activity.RESULT_OK){
            if (requestCode == CAMERA){
                data?.extras?.let {
                    ...
                    //mBinding.ivDishImage.setImageBitmap(thumbnail)    //old way
            ...
            if (requestCode == GALLERY){
                data?.let {
                    ...
                    //mBinding.ivDishImage.setImageURI(selectedPhotoUri)    //old way
    ...
    private fun saveImageToInternalStorage(bitmap: Bitmap): String{
        ...
        file = File(file,"${UUID.randomUUID()}.jpg")    //random id for image
        ...
        return file.absolutePath    //Return the directory in which the file exists, as well as the
                        // name of the file itself. And this file will then be our compressed image.
    }
